...
class Main {
    ...
    createTopToolbar() {
        ...
        let showFileInfo = document.createElement('a');
        ...
        let insertUnit = document.createElement('a');
        ...
        let deleteUnits = document.createElement('a');
        ...
        let sortUnits = document.createElement('a');
        ...
        let filterUnits = document.createElement('a');
        ...
        let maintenance = document.createElement('a');
        ...
        let convertCSV = document.createElement('a');
        ...
        let convertExcel = document.createElement('a');
        ...
        let openHelp = document.createElement('a');
    ...
    buildRightPanels(rightPanel) {
        ...
        let divider = new ThreeHorizontalPanels(panelsContainer);
    ...
    createAttributesPanel(topPanel) {
        ...
        let attributesCell = document.createElement('td');
        ...
        let editAttributes = document.createElement('a');
        ...
        let attributesPanel = document.createElement('div');
    ...
    createPropertiesPanel(centerPanel) {
        ...
        let tableRow = document.createElement('tr');
        titleTable.appendChild(tableRow);
        let propertiesCell = document.createElement('td');
        ...
        let editCell = document.createElement('td');
        tableRow.appendChild(editCell);
        let editProperties = document.createElement('a');
    ...
    createNotesPanel(bottomPanel) {
        ...
        let editCell = document.createElement('td');
        tableRow.appendChild(editCell);
        let editNotes = document.createElement('a');
    ...
    createBottomToolbar() {
        ...
        let pageTooltip = document.createElement('span');
        ...
        let unitsPage = document.createElement('span');
        ...
        units.addEventListener('keydown', (ev) => {
            this.setUnitsPage(ev);
        });
        unitsDiv.appendChild(units);
        let unitsTooltip = document.createElement('span');
        ...
        let unitsLabel = document.createElement('span');
        ...
        let unitsCount = document.createElement('span');
        unitsCount.id = 'units';
    ...
    dataSaved(arg) {
        var tr = document.getElementById(arg.id);
    ...
    updateSegments(arg) {
        ...
        length = cells.length;
        for (let i = 0; i < length; i++) {
            cells[i].addEventListener('click', (ev) => this.clickListener(ev));
        }
        var fixed = document.getElementsByClassName('fixed');
        length = fixed.length;
        for (let i = 0; i < length; i++) {
            fixed[i].addEventListener('click', (ev) => this.fixedListener(ev));
        }
        document.getElementById('attributesTable').innerHTML = '';
        document.getElementById('attributesSpan').innerHTML = 'TU';
        document.getElementById('propertiesTable').innerHTML = '';
    ...
    previousPage() {
        if (this.currentPage > 0) {
            ...
            this.currentPage--;
            document.getElementById('page').value = '' + (this.currentPage + 1);
            this.getSegments();
        }
    }
    nextPage() {
    ...
    setUnitsPage(event) {
        ...
        if (event.code === 'Enter' || event.code === 'NumpadEnter') {
            this.unitsPage = Number.parseInt(document.getElementById('units_page').value);
            if (this.unitsPage < 1) {
                this.unitsPage = 1;
            }
            ...
            document.getElementById('units_page').value = '' + this.unitsPage;
            this.maxPage = Math.ceil(this.unitsCount / this.unitsPage);
            document.getElementById('pages').innerText = '' + this.maxPage;
            if (this.currentCell !== null && this.currentCell.isContentEditable) {
                this.saveEdit();
    ...
    setPage(event) {
        ...
        if (event.code === 'Enter' || event.code === 'NumpadEnter') {
            this.currentPage = Number.parseInt(document.getElementById('page').value) - 1;
            if (this.currentPage < 0) {
                this.currentPage = 0;
            }
            if (this.currentPage > this.maxPage - 1) {
    ...
    unitInserted(arg) {
        ...
        td1.addEventListener('click', (ev) => this.clickListener(ev));
        tr.appendChild(td1);
        ...
        for (let index = 0; index < length; ++index) {
            ...
            td.addEventListener('click', (ev) => this.clickListener(ev));
            tr.appendChild(td);
        }
        document.getElementById('tableBody').insertBefore(tr, document.getElementById('tableBody').firstChild);
    }
}
Main.EDIT = '<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">' +
